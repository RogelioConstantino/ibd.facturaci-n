<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BasesContratoCarga.aspx.cs" Inherits="Ibd.SiMer.Web.BasesContratoCarga" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cuerpo" runat="server">
    ...
    <div class="col s12 center">             
        <h5 style="color: #427314 !important;"> Carga de archivo de Bases de Contrato </h5> 
    </div>
    ...
    <form id="form1" name="form1" runat="server">        
        <div class="row">                                               
            <div class="input-field col s1 offset-s2">
                <asp:DropDownList ID="ddl_year" runat="server" ClientIDMode="Static" >                </asp:DropDownList >                    
                <label class="active" for="ddl_year">Año</label>
            </div>                    
            <div class="input-field col s1">  
                <asp:DropDownList ID="ddl_month" runat="server" ClientIDMode="Static" >                </asp:DropDownList>
                <label class="active" for="ddl_month">Mes</label>
            </div>
            <div class="input-field col s3">  
                <asp:DropDownList ID="ddl_puntoCarga" runat="server" ClientIDMode="Static" >                </asp:DropDownList>
                <label class="active" for="ddl_puntoCarga">Central</label>
            </div>        
        ...
        <div style="padding:10px;">            
            ...
            <div id="modal1" class="modal " style="    height: 375px !important;  width: 930px !important; ">
                <div class="modal-content">              
                    <h4 class="light-green-text text-darken-4">Carga de archivo de resumen</h4>
                    <p>Importar desde un archivo de excel el resumén de facturación que envia CFE de uan central.</p>                    
                    <div class="row">                
                        <div class="col s12 center">                    
    ...
    <script type = "text/javascript">
            function Confirm() {
                ...
                if (confirm("¿Confirmar carga de archivo de Bases de contrato?")) {
