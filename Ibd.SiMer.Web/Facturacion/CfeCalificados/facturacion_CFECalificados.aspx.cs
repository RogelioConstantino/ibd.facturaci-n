...
{
    public partial class facturacion_CFECalificados : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dtG;
                dtG = clsNe.obtieneAñosResumenCFECalificados();
                ...
                dtG = clsMesesNe.obtieneMesesCFECalificados(int.Parse(ddl_year.SelectedItem.Value));
                ds = new DataSet();
        ...
        public static List<PuntoCargaFac> Consulta(string Anio, string Mes, string Tipo)
        {
            ...
            try
            {
                lista = pcDa.ConsultarPrevioCFECalificados(Anio, Mes, Tipo);
            }
            catch (Exception ex)
            {
                Console.Write(ex);
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static List<PuntoCargaFac> GenerarAnexos(string Ids, string Mes, string Usuario, string Tipo)
        {
            ...
            try
            {               
                    lista = pcDa.GenerarAnexoCFECalificados(Ids, Mes, ruta, Usuario);               
            }
            catch (Exception ex)
            {
                Console.Write(ex);
        ...
        public static List<PuntoCargaFac> GenerarPDF(string Ids, string Mes, string Usuario, string Tipo)
        {
            ...
            try
            {
                lista = pcDa.GenerarPDFCfeCalificados(Ids, Mes, ruta, Usuario);
            }
            catch (Exception ex)
            {
                Console.Write(ex);
