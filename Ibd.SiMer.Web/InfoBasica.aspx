<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="InfoBasica.aspx.cs" Inherits="Ibd.SiMer.Web.InfoBasica" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cuerpo" runat="server">
    ...
    <div class="col s12 center">             
        <h5 style="color: #427314 !important;">Tabla de Información Básica</h5> 
    </div>        
    <br />    
        ...
        <div style="padding:10px;">            
            ...
            <div id="modal1" class="modal " style="    height: 375px !important;  width: 930px !important; ">
                <div class="modal-content">              
                    <h4 class="light-green-text text-darken-4">Carga de archivo de Tabla IB</h4>
                    <p>Importar desde un archivo de excel la Tabla IB por central.</p>
                    <div class="row">                        
