<%@ Page Title="" Language="C#" MasterPageFile="~/costos.Master" AutoEventWireup="true" CodeBehind="ResumenCFECostos.aspx.cs" Inherits="Ibd.SiMer.Web.ResumenCFECostos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cuerpo" runat="server">
    ...
    <%--	<link href="http://www.jqueryscript.net/css/jquerysctipttop.css" rel="stylesheet" type="text/css"/>
        ...
        <div class="col s12 center">             
            <h5 style="color: #427314 !important;">Consulta de Resumen de CFE </h5> 
        </div>
