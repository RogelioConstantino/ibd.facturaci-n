<%@ Page Title="" Language="C#" MasterPageFile="~/costos.Master" AutoEventWireup="true" CodeBehind="ResumenCFECostosTransCarga.aspx.cs" Inherits="Ibd.SiMer.Web.ResumenCFECostosTransCarga" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cuerpo" runat="server">
    ...
    <div class="col s12 center">             
        <h5 style="color: #427314 !important;">Carga de archivo de Resumen CFE</h5> 
    </div>
        ...
        <div style="padding:10px;">            
            ...
            <div id="modal1" class="modal " style="    height: 375px !important;  width: 930px !important; ">
                <div class="modal-content">              
                    <h4 class="light-green-text text-darken-4">Carga de archivo de Resumen CFE</h4>
    ...
    <script type = "text/javascript">
            function Confirm() {
                ...
                if (confirm("¿Confirmar carga de archivo de Resumen CFE?")) {
