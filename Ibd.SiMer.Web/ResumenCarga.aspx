<%@ Page Title="" Language="C#" MasterPageFile="~/Main2.Master" AutoEventWireup="true" CodeBehind="ResumenCarga.aspx.cs" Inherits="Ibd.SiMer.Web.ResumenCarga" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cuerpo" runat="server">
    ...
    <div class="col s12 center">             
        <h5 style="color: #427314 !important;">Carga de archivo de resumen </h5> 
    </div>
    ...
    <script type = "text/javascript">
            function Confirm() {
                ...
                if (confirm("¿Confirmar carga de archivo de resumen?")) {
