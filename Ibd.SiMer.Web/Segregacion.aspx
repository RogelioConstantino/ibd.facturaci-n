<%@ Page Title="" Language="C#" MasterPageFile="~/Main2.Master" AutoEventWireup="true" CodeBehind="Segregacion.aspx.cs" Inherits="Ibd.SiMer.Web.Segregacion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cuerpo" runat="server">
    ...
    <div class="col s12 center">             
        <h5 style="color: #427314 !important;">Segregación</h5> 
    </div>
    ...
    <form id="form1" name="form1" runat="server">        
        ...
        <div class="row">                                               
            ...
            <div class="input-field col s2 text-right offset-s1">
                <asp:LinkButton ID="LinkButton2" name="LinkButton2"  CssClass="btn olive waves-effect waves-light light-green darken-3 right" runat="server" Text="Buscar"    ClientIDMode="Static"  >  
