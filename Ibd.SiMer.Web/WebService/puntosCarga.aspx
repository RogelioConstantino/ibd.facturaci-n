<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="puntosCarga.aspx.cs" Inherits="Ibd.SiMer.Web.puntosCarga" %>
                    ...
                    <div class="row">    
                          <div class="row">
                            <div class="input-field col s6">                                                            
                                 ...
                                 <cc1:CascadingDropDown ID="cdl_Grupos" TargetControlID="ddl_Grupos" PromptText="Seleciona un Grupo"
                                    PromptValue="" ServicePath="WebService/wsGrupos.asmx" ServiceMethod="getGrupos" runat="server"
                                    Category="Id" LoadingText="Cargando..." />  
                                <label for="txt_Grupo" class="active">Grupo	</label>
                                <input placeholder="Grupo" id="txt_Grupo" type="text" readonly/>
                            </div>
                            <div class="input-field col s6">
                                 <asp:DropDownList ID="ddl_Clientes" runat="server" ClientIDMode="Static" style="display:block !important;" >
                                 </asp:DropDownList>
                              ...
                              <input  placeholder="Cliente" id="txt_cliente" type="text"  readonly/>
                              <label for="txt_cliente" class="active">Cliente</label>
                            </div>
                          </div>                      
                          <div class="row">
