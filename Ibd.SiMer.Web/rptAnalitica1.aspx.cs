...
{
    public partial class rptAnalitica1 : System.Web.UI.Page
    {
        ...
        private void buscar()
        {
            ...
            dtGR = oclsRpt.rptAnaliticaAltamira(strAño, strMes);
        ...
        private void ExporttoExcelClosedXML(DataSet ds)
        {
            ...
            string strNamefile = "DetalleAnalitica_Altamira_" + DateTime.Now.ToString("yyyymm") + ".xlsx";
