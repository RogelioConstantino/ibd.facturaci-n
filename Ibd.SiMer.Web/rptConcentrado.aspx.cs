...
{
    public partial class rptConcentrado : System.Web.UI.Page
    {
        ...
        private void buscar()
        {
            ...
            dtGR = oclsRpt.GetGeneralReport (strFecIni, strFecFin, strPunto.ToString());
        ...
        private void ExporttoExcelClosedXML(DataSet ds)
        {
            ...
            string strNamefile = "Concentrado_Mercado_" + DateTime.Now.ToString("ddMMyyyyhhmmss") + ".xlsx";
